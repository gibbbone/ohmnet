...
def parse_args():
    ...
    parser.add_argument(
        '--hierarchy', 
        nargs='?', default='data/brain.hierarchy',
    ...
    parser.add_argument(
        '--weighted', 
        dest='weighted', action='store_true', default=False,
        help='Boolean specifying (un)weighted. Default is unweighted.')
    
    parser.add_argument(
        '--unweighted', 
        dest='unweighted', action='store_false')    

    parser.add_argument(
        '--directed', 
        dest='directed', action='store_true', default=False,
        help='Graph is (un)directed. Default is undirected.')
    
    parser.add_argument(
        '--undirected', 
        dest='undirected', action='store_false')    

    parser.add_argument(
        '--nodetype', 
        type=str, default='int',
        help='Type of node expected in edgelist files. Default is int.')
...
def main(args):
    on = ohmnet.OhmNet(
        ...
        out_dir=args.outdir, nodetype=args.nodetype)
    on.embed_multilayer()
